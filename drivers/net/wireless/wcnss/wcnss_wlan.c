    ...
    if (pchCmd != NULL) {
        ...
        if (pchModel != NULL) {
            ...
            if (!strcmp(pchModel, "LG-K200DS")) {
                iFCCModel = 0;
            } else if (!strcmp(pchModel, "LG-K200DSF")) {
                iFCCModel = 1;
            } else if (!strcmp(pchModel, "LG-K200MT")) {
                iFCCModel = 1;
            } else if (!strcmp(pchModel, "LG-K200F")) {
                iFCCModel = 1;
            } else if (!strcmp(pchModel, "LG-K200AR")) {
                iFCCModel = 1;
            } else {
                pr_err("wcnss: Could not find Model Name\n");
            }
        }
    }
    if (iFCCModel == 0) {
